...
public partial class @WidgetEditLine
{
    ...
    [FieldOffset(680)] public string @ReactionEnter;
    [FieldOffset(704)] public string @reactionDown;
    [FieldOffset(728)] public string @reactionUp;
    [FieldOffset(752)] public bool @isPassword;
}
