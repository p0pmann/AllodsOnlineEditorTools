...
public partial class @WidgetTextContainer
{
    ...
    [FieldOffset(400)] public ResourcePointer @border;
    [FieldOffset(408)] public float @elementFixedSize;
    [FieldOffset(412)] public float @elementsInterval;
    [FieldOffset(416)] public int @elementsLimit;
    [FieldOffset(424)] public ResourcePointer @scrollBar;
    [FieldOffset(432)][EnumRef(typeof(Enums.@e_1cb14a0))] public int @widgetsArrangement;
    [FieldOffset(448)] public WString @defaultTag;
    [FieldOffset(472)] public TextFileRef @formatFileRef;
    [FieldOffset(504)] public bool @pickObjectsOnly;
    [FieldOffset(505)] public bool @rotateOnLimit;
}
