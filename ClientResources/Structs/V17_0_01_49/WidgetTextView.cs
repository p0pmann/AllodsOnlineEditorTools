...
public partial class @WidgetTextView
{
    ...
    [FieldOffset(400)] public WString @DefaultTag;
    [FieldOffset(424)] public TextFileRef @FormatFileRef;
    [FieldOffset(456)] public Layouts.@s_1cd77f0 @TextStyle;
    [FieldOffset(480, ArrayStride = 64)] public Layouts.@s_1c5cd20[] @TextValues;
    [FieldOffset(512)] public float @maxWidth;
    [FieldOffset(516)] public float @minWidth;
    [FieldOffset(520)] public bool @isHtmlEscaping;
    [FieldOffset(521)] public bool @pickObjectsOnly;
}
