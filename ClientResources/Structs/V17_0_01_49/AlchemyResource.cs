...
public partial class @AlchemyResource
{
    ...
    [FieldOffset(376, ArrayStride = 8)] public ResourcePointer[] @particularRecipes;
    [FieldOffset(408, ArrayStride = 8)] public ResourcePointer[] @recipes;
    [FieldOffset(448, ArrayStride = 12)] public Layouts.@s_15271b0[] @availableLines;
    [FieldOffset(480, ArrayStride = 4)] public int[] @correctionGrowthScores;
    [FieldOffset(512)] public int @defaultResultCount;
    [FieldOffset(516)] public int @perComponentBonus;
    [FieldOffset(520)] public int @perfectBonus;
    [FieldOffset(528, ArrayStride = 4)] public int[] @slotsForProperties;
    [FieldOffset(560)] public float @unusedRollsBonus;
}
